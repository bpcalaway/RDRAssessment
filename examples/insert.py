...
all_data = [
    ...
    {"user_id": 2, "title": "Independence Day", "description": "Time off scheduled for  7/04/2099"},
    {"user_id": 2, "title": "New Years Party", "description": "Work party scheduled for 12/31/2099"},
]
